...
// src/client/shared/local-command.js
var NAVIGATION_COMMANDS = Object.freeze(/* @__PURE__ */ new Map([
  ["/\u7EC3\u4E60\u5217\u8868", "library"],
  ["/\u5F53\u524D\u7EC3\u4E60", "current"],
  ["/\u529B\u6263\u5217\u8868", "leetcode"],
...
var LOCAL_COMMAND_EXAMPLE = "/\u7EC3\u4E60\u5217\u8868  /\u5207\u6362 <\u7EC3\u4E60ID>  /\u5B8C\u6210 <\u9898\u76EE\u6807\u8BC6>";
...
function WorkspaceDock({ sessionId }) {
  ...
  const [commandText, setCommandText] = import_react7.default.useState("");
  const [commandError, setCommandError] = import_react7.default.useState("");
  const [commandBusy, setCommandBusy] = import_react7.default.useState(false);
  ...
  return h(
    ...
    open ? h(
      ...
      h(
        ...
        h("button", { type: "button", onClick: () => setOpen(false), "aria-label": "\u5173\u95ED\u7EC3\u4E60\u5DE5\u4F5C\u53F0" }, "\xD7")
      ),
      h(
        "form",
        {
...
.di-local-command{position:relative;display:grid;grid-template-columns:18px minmax(0,1fr) auto;align-items:center;gap:6px;height:46px;padding:7px 18px;border-bottom:1px solid var(--di-line);background:#f8faff}.di-local-command>span{color:var(--di-blue);font:800 14px/1 ui-monospace,"Cascadia Mono",monospace;text-align:center}.di-local-command input{min-width:0;border:0;padding:6px 4px;background:transparent;color:var(--di-ink);font:12px/1.4 ui-monospace,"Cascadia Mono","Microsoft YaHei",monospace}.di-local-command input:focus{outline:0}.di-local-command button{appearance:none;border:0;border-radius:6px;padding:7px 10px;background:var(--di-blue);color:#fff;font:700 11px/1 "Segoe UI Variable","Segoe UI",sans-serif;cursor:pointer}.di-local-command button:disabled{opacity:.45;cursor:not-allowed}.di-local-command-error{position:absolute;z-index:2;top:39px;right:18px;left:42px;padding:7px 9px;border:1px solid #ffd4d8;border-radius:6px;background:#fff7f8;color:var(--di-red);font-size:11px;box-shadow:0 6px 18px rgba(70,20,25,.08)}.di-workspace-layout{height:calc(100% - 116px)}
