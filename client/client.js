...
var localQuestionListeners = /* @__PURE__ */ new Set();
...
// src/client/features/latest-question-dock.js
var import_react7 = __toESM(require("react"), 1);
function LatestQuestionDock({ sessionId, transcriptKey }) {
  const [entry, setEntry] = import_react7.default.useState(null);
...
function apply(ctx) {
  ...
  slots.inject("conversation.input.dock", () => slots.register(
    ...
    (props) => {
      const transcriptKey = typeof props.useSession === "function" ? props.useSession((snapshot) => {
