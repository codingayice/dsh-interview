...
.di-workspace-backdrop{position:fixed;z-index:53;inset:0;display:grid;place-items:center;padding:24px;background:rgba(15,23,42,.24);backdrop-filter:blur(3px);font-family:"Segoe UI Variable","Segoe UI","Microsoft YaHei",sans-serif}.di-workspace-panel{position:relative;right:auto;bottom:auto;width:min(1180px,calc(100vw - 48px));height:min(790px,calc(100vh - 48px));border-color:#e2e7ef;border-radius:17px;background:var(--di-white);box-shadow:0 28px 90px rgba(15,23,42,.22)}.di-workspace-head{height:72px;padding:0 20px 0 26px}.di-workspace-brand{display:flex;align-items:center;gap:12px}.di-workspace-brand-icon{display:inline-flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:10px;background:var(--di-blue);color:#fff;box-shadow:0 6px 14px rgba(36,92,255,.2)}.di-workspace-head h2{font-size:20px}.di-workspace-head>button{display:inline-flex;align-items:center;justify-content:center}.di-workspace-layout{grid-template-columns:196px minmax(0,1fr);height:calc(100% - 72px)}.di-workspace-tabs{gap:4px;padding:18px 12px;background:#f6f8fb}.di-workspace-tabs button{display:flex;align-items:center;gap:11px;border-radius:8px;padding:12px 13px;font-size:13px;line-height:1.2}.di-workspace-tabs button::before{top:8px;bottom:8px;left:-12px}.di-workspace-tabs button:hover{background:rgba(255,255,255,.68)}.di-workspace-tabs button.is-active{background:var(--di-white);box-shadow:0 1px 3px rgba(15,23,42,.05)}.di-workspace-tabs button.is-active::before{left:-12px}.di-workspace-content{padding:24px;background:#f8fafc}.di-workspace-content>.di-ledger,.di-workspace-content>.di-lc-catalog{border-color:#e3e8f0;border-radius:12px;background:var(--di-white);box-shadow:0 3px 12px rgba(15,23,42,.04)}.di-history-head{min-height:68px;padding:16px 20px}.di-ledger-title{font-size:19px}.di-history-filters{padding:12px 20px;background:var(--di-white)}.di-history-filters .di-input{padding-left:13px}.di-input,.di-select{height:36px;border-color:#dce3ed;border-radius:7px}.di-input:hover,.di-select:hover{border-color:#c4cfdf}.di-history-table th{padding:11px 20px;border-top:1px solid var(--di-line);background:#f8fafc;font-size:12px}.di-history-table td{padding:12px 20px}.di-history-table tbody tr{transition:background .15s ease}.di-history-table tbody tr:hover td{background:#fafcff}.di-history-table tr.is-selected td{background:#f1f5ff}.di-history-topic{max-width:320px;overflow:hidden;text-overflow:ellipsis}.di-icon-button{width:32px;height:30px;border-color:transparent;background:transparent}.di-icon-button:hover:not(:disabled){transform:none;background:#f3f6fb;box-shadow:none}.di-icon-button.is-delete{border-color:transparent;background:transparent}.di-history-detail{background:#fff}.di-detail{padding:24px 20px}.di-detail-heading{padding-bottom:14px;border-bottom:1px solid var(--di-line)}.di-practice-form{margin:0;border-bottom:1px solid var(--di-line);background:#f8fafc}.di-modal-backdrop{position:absolute;z-index:20;inset:0;display:grid;place-items:center;padding:24px;background:rgba(15,23,42,.28);backdrop-filter:blur(2px)}.di-confirm-modal{width:min(390px,100%);padding:22px;border:1px solid var(--di-line);border-radius:12px;background:#fff;box-shadow:0 20px 55px rgba(15,23,42,.2)}.di-confirm-modal h4{margin:0;font-size:17px;font-weight:var(--di-weight-title)}.di-confirm-modal p{margin:10px 0 0;color:var(--di-muted);font-size:13px;line-height:1.6}.di-confirm-modal .di-actions{justify-content:flex-end;margin-top:20px}.di-workspace-content>.di-lc-catalog .di-lc-catalog-head{padding-top:20px}.di-workspace-content>.di-lc-catalog .di-lc-title{font-size:19px}.di-workspace-content>.di-lc-catalog .di-lc-groups{padding-bottom:20px}.di-workspace-launcher{right:20px;bottom:20px;padding:8px 14px 8px 8px}.di-local-toast{right:24px;bottom:24px}
...
@media(max-width:760px){.di-question-card,.di-lc-problem-card{grid-template-columns:1fr;padding:22px}.di-lc-problem-actions{justify-content:flex-start;max-width:none}.di-lc-group{grid-template-columns:1fr;gap:10px}.di-lc-group-head{justify-content:flex-start}.di-answer-button{justify-self:start}.di-history-table th,.di-history-table td{padding-left:16px;padding-right:16px}.di-history-filters{flex-wrap:wrap}.di-input{flex-basis:100%}.di-timeline{display:none}.di-workspace-backdrop{padding:8px;place-items:stretch}.di-workspace-panel{width:100%;height:100%;border-radius:12px}.di-workspace-layout{grid-template-columns:1fr;grid-template-rows:auto minmax(0,1fr)}.di-workspace-tabs{flex-direction:row;padding:6px;border-right:0;border-bottom:1px solid var(--di-line);overflow-x:auto}.di-workspace-tabs button{white-space:nowrap}.di-workspace-tabs button::before{top:auto;right:12px;bottom:-6px;left:12px;width:auto;height:2px}.di-workspace-tabs button.is-active::before{left:12px}.di-workspace-content{padding:10px}.di-workspace-launcher{right:10px;bottom:12px}}
